...
from ..format import build_system_prompt, format_training_text, xlam_answers_to_action_json

def _iter_xlam(path, limit=0):
    ...
    for item in data:
        ...
        text = format_training_text(system=system, user=query, assistant_tool_json=action_json)
        yield {
...
def convert_xlam(input_path, out_train, out_val, val_ratio=0.1, limit=0):
