...
def export_schemas(out=SCHEMAS_PATH, kiosk_root=None):
    ...
    raise FileNotFoundError(
        f"Kiosk repo not found and no bundled schemas. Clone kiosk or set KIOSK_ROOT. Expected bundled file: {out}"
    )
