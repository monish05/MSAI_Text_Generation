#!/usr/bin/env python3
"""CLI for two-pass kiosk-style generation."""
...
def main() -> None:
    ...
    tool_result = args.tool_result.read_text(encoding="utf-8") if args.tool_result and args.tool_result.exists() else None
    out = generate_response(model, tokenizer, tool_schemas=schemas, question=args.prompt, tool_result=tool_result, device=device)
